...
import { subscriptionPlans, testimonials, therapists, workshops, resources, stats } from '../mockData';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="#resources" className="text-slate-600 hover:text-teal-600 transition-colors">Resources</a>
            ...
            <div className="flex space-x-3">
              ...
              <Link to="/auth">
                <Button className="bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700">Get Started</Button>
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Connect with licensed therapists, access personalized resources, and take control of your mental health journey in a safe, confidential space.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600">
              Choose your path and start your mental wellness journey
            </p>
          </div>

          <Tabs defaultValue="individual" className="w-full">
            <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 mb-12">
              <TabsTrigger value="individual" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-teal-600 data-[state=active]:to-cyan-600 data-[state=active]:text-white">
                <Users className="w-4 h-4 mr-2" />
                Individual
              </TabsTrigger>
              <TabsTrigger value="professional" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-cyan-600 data-[state=active]:to-blue-600 data-[state=active]:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-xl transition-all">
              ...
              <CardContent>
                <p className="text-slate-600">All communications are encrypted and secure, ensuring complete confidentiality.</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-xl transition-all">
              ...
              <CardContent>
                <p className="text-slate-600">Video calls, messaging, and voice sessions - choose what works for you.</p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600">
              Book one-on-one sessions or join group workshops
            </p>
          </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <Button size="sm" className="bg-gradient-to-r from-teal-600 to-cyan-600">Book Now</Button>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card key={workshop.id} className="hover:shadow-lg transition-shadow">
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between">
                        ...
                        <Button size="sm" variant="outline" className="border-teal-600 text-teal-600 hover:bg-teal-50">Register</Button>
                      </div>
                    </CardContent>
                  </Card>
                ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {subscriptionPlans.map(plan => (
              <Card key={plan.id} className={`relative hover:shadow-2xl transition-all ${plan.popular ? 'border-2 border-teal-500' : ''}`}>
                {plan.popular && (
      ...
      <section id="resources" className="py-20 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600">
              Curated mental wellness guides and resources
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600">
              Comprehensive analytics for enterprise wellness programs
            </p>
          </div>
          ...
          <Card className="bg-gradient-to-br from-slate-50 to-white border-2 border-slate-200">
            <CardContent className="p-8">
              <div className="text-center">
                ...
                <p className="text-slate-600 mb-6">Join leading organizations providing mental health support to their teams</p>
                <Button size="lg" className="bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700">
      ...
      <TestimonialsSection
        ...
        description="Real stories from real people transforming their mental wellness journey"
      ...
      <footer id="contact" className="bg-slate-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">Soul Space</span>
              </div>
              <p className="text-slate-400 text-sm">
                Your trusted partner for mental wellness and emotional support.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-sm text-slate-400">
            <p>© 2025 Soul Space. All rights reserved. HIPAA Compliant • Secure & Confidential</p>
          </div>
        </div>
      </footer>
    </div>
